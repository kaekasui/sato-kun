...
# TRELLO_DONE_LIST_ID
# TRELLO_DONE_ANIME_LIST_ID
# TRELLO_DONE_ACCOUNT_LIST_ID
...
module.exports = (robot) ->
  ...
  new cronJob(
    ...
    timeZone: "Asia/Tokyo"
    onTick: ->
      getCards(board_id, done_list_id)
      getCards(anime_board_id, anime_done_list_id)
      getCards(account_board_id, account_done_list_id)
  )
